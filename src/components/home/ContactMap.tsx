    ...
    const content = (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <Reveal delay={0.2} className="w-full">
                <div className="space-y-12 max-w-lg">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                        ...
                        <Button variant="secondary" className="px-8" onClick={openRoute}>
            ...
            <Reveal delay={0.4} className="w-full">
                <div className="relative aspect-[4/5] md:aspect-square lg:aspect-auto lg:h-[600px] rounded-[24px] overflow-hidden shadow-premium group border border-[#3A3A3A]/[0.05] bg-white">

...
description: Guides psychology-driven UI/UX design, design systems, tokens, accessibility, and component patterns. Use when designing interfaces, creating design systems, building UI components, applying UX psychology laws, or implementing accessible, token-based styling.
---

# UI/UX Design System

Comprehensive guidance for beautiful, psychology-driven UI/UX based on proven principles and design best practices.
...
- [ ] Jakob's Law (platform conventions)
- [ ] Gestalt principles (visual grouping)
- [ ] Doherty Threshold (<400ms interactions)
- [ ] WCAG AA contrast
- [ ] Keyboard navigation
